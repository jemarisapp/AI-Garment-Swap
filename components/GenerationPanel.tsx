...
import { X, Sparkles, Wand2, User, Image as ImageIcon, Shirt, Maximize, MapPin, Tag, Upload, LayoutGrid, Check } from 'lucide-react';
...
interface GenerationPanelProps {
  mode: 'scene' | 'object';
  onGenerateScene: (params: SceneGenerationParams) => void;
  onGenerateObject: (params: ObjectGenerationParams) => void;
  onCancel: () => void;
...
export const GenerationPanel: React.FC<GenerationPanelProps> = ({
  ...
  const handleSubmit = () => {
    if (mode === 'scene') {
      ...
      onGenerateObject({ prompt: objectPrompt, type: garmentType });
    }
  };
